...
public class TimetableContract {
    ...
    private interface TimetableColumns extends BaseColumns {
        ...
        String[] FIRST_VAR = {DEPARTURE_STATION_ID, DEPARTURE_STATION_NAME, DEPARTURE_TIME,
                ARRIVAL_STATION_ID, ARRIVAL_STATION_NAME, ARRIVAL_TIME, TRAIN_ROUTE_ID,
                ROUTE_START_STATION_NAME, ROUTE_END_STATION_NAME};
        String[] SECOND_VAR = {DEPARTURE_STATION_ID, DEPARTURE_STATION_NAME, DEPARTURE_TIME,
                ARRIVAL_STATION_ID, ARRIVAL_STATION_NAME, ARRIVAL_TIME, TRAIN_ROUTE_ID,
                ROUTE_START_STATION_NAME, ROUTE_END_STATION_NAME, TRAIN_NAME};
    }

    public static final class Timetable implements TimetableColumns {
        public static final String TABLE = "timetable";
        private static final String NEW_TABLE = "CREATE TABLE " + TABLE +
        ...
        public static final String NEW_FIRST_VAR = NEW_TABLE
                + " )";
        public static final String NEW_SECOND_VAR = NEW_TABLE
                + ", " + TRAIN_NAME + " TEXT )";
    }
}
