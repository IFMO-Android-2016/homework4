...
import static ru.ifmo.droid2016.rzddemo.cache.TimetableContract.TimetableColumns.ARRIVALSTATIONID;
import static ru.ifmo.droid2016.rzddemo.cache.TimetableContract.TimetableColumns.DEPARTUREDATE;
import static ru.ifmo.droid2016.rzddemo.cache.TimetableContract.TimetableColumns.DEPARTURESTATIONID;
import static ru.ifmo.droid2016.rzddemo.cache.TimetableContract.TimetableColumns.TRAINNAME;
...
public class TimetableCache {
    ...
    public List<TimetableEntry> get(@NonNull String fromStationId,
        ...
        try {
            ...
            throw new FileNotFoundException("No data in timetable cache for: fromStationId="
                    + fromStationId + ", toStationId=" + toStationId + ", dateMsk=" + LOG_DATE_FORMAT.format(dateMsk.getTime()));
        } finally {
            if (c != null) {
                c.close();
            }
